            ...
            <div className={s.center}>
                <nav className={s.nav + " mt-4"}>
                    <div className={s.container}>
                        <div className={"mr-1"}>
                            <HeaderButton
                                icon={<BurgerIcon type={location.pathname === '/' ? 'primary' : 'secondary'}/>} link='/'
                                text="Конструктор" type={location.pathname === '/' ? 'primary' : 'secondary'}/>
                        </div>
                        <div className={"ml-1"}>
                    ...
                    <div className={s.profile}>
                        <HeaderButton
                            icon={<ProfileIcon type={location.pathname === '/profile' ? 'primary' : 'secondary'}/>}
